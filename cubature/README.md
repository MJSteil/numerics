...
\f{eqnarray*}{\int_{a_1}^{b_1}\int_{a_2}^{b_2}\ldots\int_{a_n}^{b_n}\mathrm{d}^nx\,\vec{f}(\vec{x}) \f}
...
GNU General Public License (v2 or later), implements two algorithms for adaptive integration.
